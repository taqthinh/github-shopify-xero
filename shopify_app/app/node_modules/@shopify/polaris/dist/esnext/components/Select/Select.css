...
.Polaris-Select--newDesignLanguage_1rik8 .Polaris-Select__Backdrop_1x2i2{ z-index:10; top:0; right:0; bottom:0; left:0; border:0.1rem solid var(--p-border); border-radius:var(--p-border-radius-base); background-color:var(--p-surface); position:relative; position:absolute; }
