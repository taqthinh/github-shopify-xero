...
var TopBar = function TopBar({
  ...
  } = useToggle$1(false); // eslint-disable-next-line react-hooks/exhaustive-deps

  var handleScroll = useCallback(debounce$1(() => {
  ...
  var scrollListenerMarkup = newDesignLanguage ? /*#__PURE__*/React$1.createElement(EventListener$1, {
    event: "scroll",
    handler: handleScroll,
    passive: true
  }) : null;
  var className = classNames(styles.TopBar, newDesignLanguage && styles['TopBar-newDesignLanguage'], scrolled && styles.isScrolled);
